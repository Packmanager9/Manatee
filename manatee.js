...
window.addEventListener('DOMContentLoaded', (event) =>{
    ...
    class Manatee{
        ...
        draw(){
            ...
            this.body.draw()
            this.head.x = this.body.x + (Math.cos(this.globalangle)*10)
            this.head.y = this.body.y + (Math.sin(this.globalangle)*10)
            let redline = new Line(this.body.x, this.body.y,  (this.body.x + (Math.cos(this.globalangle)*30)),  (this.body.y + (Math.sin(this.globalangle)*30)), 'red', 3  )

            let cyanline = new Line(this.body.x, this.body.y,  (this.body.x + (Math.cos(this.trajectoyangle)*30)),  (this.body.y + (Math.sin(this.trajectoyangle)*30)), 'cyan', 3  )
        
            let whiteline = new Line(this.body.x, this.body.y,  (this.body.x + (Math.cos(this.trajectoyangleflip)*30)),  (this.body.y + (Math.sin(this.trajectoyangleflip)*30)), 'white', 3  )
            whiteline.draw()     
            cyanline.draw()  
                 redline.draw()
            this.head.draw()
    ...
    for(let h = 0; h < 200000; h++){
        let a1 = new Rectangle(-350000+(Math.random()*tutorial_canvas.width*1000), (6*Math.random()*tutorial_canvas.height)-3850, ((Math.random()*6)+.95),((Math.random()*6)+.95), getRandomLightColor())
